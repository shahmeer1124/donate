...
class CreatedRequestsList extends GetView<PersonController> {
  const CreatedRequestsList({Key? key}) : super(key: key);
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildBuilderDelegate(
                (context, index) {
                  var item = controller.state.createdrequestlist[index];

                  return _buildWidget(context, item);
                },
                childCount: controller.state.createdrequestlist.length,
              ),
            ),
          )
        ],
